...
<?php include ROOT . 'include/header_leader.php'; ?>
...
<div class="content_box clearfix">
	...
	<div class="depart_box">
		<h2>
			公司高层
			<a href="score.php?depart='公司高层'" target="_blank">查看部门评分</a>
		</h2>
		<table class="depart_table">
			...
			<?php foreach($userList as $key=>$user) {
				if($user["type"] == 1 && $user["depart"] == "公司高层"){
					?>
					<tr>
						<td class="t_id">0<?php echo $user["id"]?></td>
						<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>&type=1" target="_blank"><?php echo $user["name"]?></a></td>
					</tr>
				<?php }}?>
			</tbody>
		</table>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "办公室"){
				?>
					<tr>
						<td class="t_id">0<?php echo $user["id"]?></td>
						<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
					</tr>
				<?php }}?>
			</tbody>
		</table>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "安保部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "财务部"){
				?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "经营部"){
				?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "技术部"){
				?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "合约预算部"){
				?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "测量部"){
				?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "勘察部"){
				?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		<h2>
			16号线施工管理部
			<a href="score.php?depart='16号线施工管理部'" target="_blank">查看部门评分</a>
		</h2>
		<table class="depart_table">
			<thead>
			<th width="25%">#</th>
			...
			<tbody>
			<?php foreach($userList as $key=>$user) {
				if($user["type"] == 1 && $user["depart"] == "16号线施工管理部"){
					?>
					<tr>
						<td class="t_id">0<?php echo $user["id"]?></td>
						<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "物资部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "第一项目部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "外围施工项目部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "第二项目部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "第三项目部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "第四项目部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
	...
	<div class="depart_box">
		...
		<table class="depart_table">
			...
			<tbody>
				<?php foreach($userList as $key=>$user) {
					if($user["type"] == 1 && $user["depart"] == "第五项目部"){
						?>
						<tr>
							<td class="t_id">0<?php echo $user["id"]?></td>
							<td class="t_name"><a href="leaderinfo.php?id=<?php echo $user["id"]?>" target="_blank"><?php echo $user["name"]?></a></td>
